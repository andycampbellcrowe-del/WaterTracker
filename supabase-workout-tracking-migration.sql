-- Migrate workout tracking from minutes to hours
-- Run this in Supabase SQL Editor

-- ============================================================
-- DROP OLD CONSTRAINTS AND COLUMNS (if they exist)
-- ============================================================
-- Drop old constraints
ALTER TABLE household_users DROP CONSTRAINT IF EXISTS weekly_cardio_goal_quarters;
ALTER TABLE household_users DROP CONSTRAINT IF EXISTS weekly_strength_goal_quarters;

-- Drop old columns (if they exist from previous version)
ALTER TABLE household_users DROP COLUMN IF EXISTS weekly_cardio_goal_minutes;
ALTER TABLE household_users DROP COLUMN IF EXISTS weekly_strength_goal_minutes;
...
-- ============================================================
-- DROP OLD WORKOUT_ENTRIES TABLE (if exists)
-- ============================================================
...
-- Verify setup
SELECT
  'Workout tracking migration completed successfully!' as status,
